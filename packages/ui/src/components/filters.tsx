...
import {
  ButtonGroup,
  ButtonGroupText,
} from "@tablekeep/ui/components/button-group";
import {
  DropdownMenu,
...
import { Kbd } from "@tablekeep/ui/components/kbd";
import { ScrollArea } from "@tablekeep/ui/components/scroll-area";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
                          ...
                          return (
                            ...
                            >
                              <DropdownMenuSubTrigger
                                ...
                                data-highlighted={isHighlighted || undefined}
                                onMouseEnter={() => setHighlightedIndex(index)}
                                className="data-[state=open]:bg-accent data-highlighted:bg-accent data-[state=open]:text-accent-foreground data-highlighted:text-accent-foreground"
                              >
                                {field.icon}
